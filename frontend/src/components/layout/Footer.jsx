...
export default function Footer() {
  return (
    <footer className="border-t bg-gradient-to-br from-sky-800 via-sky-700 to-sky-900 text-white">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-8 sm:py-10">
        <div className="grid gap-6 sm:gap-8 sm:grid-cols-2 md:grid-cols-4">
          <div className="sm:col-span-2 space-y-3">
            <p className="text-base sm:text-lg font-semibold text-white">ResolveIt</p>
        ...
        <div className="mt-8 flex flex-col items-center justify-between gap-4 border-t border-white/20 pt-6 text-xs text-white/70 md:flex-row">
